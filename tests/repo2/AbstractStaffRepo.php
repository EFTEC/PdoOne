...
* <pre>
* $code=$pdoOne->generateCodeClass('staff','eftec\examples\clitest\repo2',array('active'=>NULL,'address_id'=>NULL,'email'=>NULL,'first_name'=>NULL,'last_name'=>NULL,'last_update'=>NULL,'password'=>NULL,'picture'=>NULL,'staff_id'=>NULL,'store_id'=>NULL,'username'=>NULL,'_address_id'=>'MANYTOONE','_store_id'=>'MANYTOONE','_payment'=>'ONETOMANY','_rental'=>'ONETOMANY','_store'=>'ONETOMANY','_tabletest'=>'ONETOMANY',),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','Sakila','',array(),array());
* </pre>
*/
abstract class AbstractStaffRepo extends Sakila
{
