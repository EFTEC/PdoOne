...
abstract class AbstractFilmRepo extends Sakila_lite
{
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		!isset($row['release_year']) and $row['release_year']=null; // varchar
		...
		!isset($row['rating']) and $row['rating']=null; // varchar
		!isset($row['special_features']) and $row['special_features']=null; // varchar
		!isset($row['last_update']) and $row['last_update']=null; // datetime
		// $row['_language_id']['_language_id']=&$row['language_id']; // linked field MANYTOONE
		// $row['_original_language_id']['_language_id']=&$row['original_language_id']; // linked field MANYTOONE
		isset($row['_film_text']) and $row['_film_text']['_film_id']=&$row['film_text']; // linked field ONETOONE
    ...
    *
    * @param string|array $recursive=['/_language_id','/_original_language_id','/_film_actor','/_film_text','/_inventory'];
    *
    * @return PdoOneQuery
    */
    ...
    */
    ...
    public static function factoryUtil():array {
        return [
		    ...
		    'special_features' => null,
		    'last_update' => null,
		    '_language_id' => LanguageRepo::factoryUtil(),
		    '_original_language_id' => LanguageRepo::factoryUtil(),
		    '_film_actor' => [FilmActorRepo::factoryUtil()],
		    '_film_text' => FilmTextRepo::factoryUtil(),
		    '_inventory' => [InventoryRepo::factoryUtil()]
		];
    }
