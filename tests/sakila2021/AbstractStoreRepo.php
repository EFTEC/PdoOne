...
abstract class AbstractStoreRepo extends Sakila_lite
{
    ...
    *
    * @param string|array $recursive=['/_address_id','/_manager_staff_id','/_customer','/_inventory','/_staff'];
    *
    * @return PdoOneQuery
    */
