...
abstract class AbstractCategoryRepo extends Sakila_lite
{
    ...
    public const DEFFK=[
		    '_film_category' => [
		        ...
		        'refcol' => '_category_id',
		        'alias' => '_film_category',
		        'colalias' => 'category_id',
    ...
    *
    * @param string|array $recursive=['/_film_category'];
    *
    * @return PdoOneQuery
    */
    ...
    */
    ...
    public static function factoryUtil():array {
        return [
		    ...
		    'name' => null,
		    'last_update' => null,
		    '_film_category' => [FilmCategoryRepo::factoryUtil()]
		];
    }
