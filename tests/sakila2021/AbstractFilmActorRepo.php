...
abstract class AbstractFilmActorRepo extends Sakila_lite
{
    ...
    public const DEFFKSQL=[
			    'actor_id' => 'FOREIGN KEY REFERENCES`actor`(`actor_id`)',
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		isset($row['_actor_id']) and $row['_actor_id']['_actor_id']=&$row['actor_id']; // linked field ONETOONE
    ...
    *
    * @param string|array $recursive=['/_actor_id','/_film_id'];
    *
    * @return PdoOneQuery
    */
    ...
    */
    ...
    public static function factoryUtil():array {
        return [
		    ...
		    'film_id' => null,
		    'last_update' => null,
		    '_actor_id' => ActorRepo::factoryUtil(),
