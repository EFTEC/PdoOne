...
abstract class AbstractLanguageRepo extends Sakila_lite
{
    ...
    public const DEFFK=[
		    '_film' => [
		        ...
		        'alias' => '_film',
		        'colalias' => 'language_id',
		        'refcolalias' => 'original_language_id',
		        'refcol2alias' => null
		    ]
		];
    ...
    *
    * @param string|array $recursive=['/_film'];
    *
    * @return PdoOneQuery
    */
