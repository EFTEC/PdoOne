 ...
 * <ul>
 * <li>rental_id: int (alias of column rental_id) </li>
 * <li>rental_date: datetime (alias of column rental_date) </li>
 * <li>inventory_id: int (alias of column inventory_id) </li>
 * <li>customer_id: int (alias of column customer_id) </li>
 * <li>return_date: datetime (alias of column return_date) </li>
 * <li>staff_id: int (alias of column staff_id) </li>
 * <li>last_update: datetime (alias of column last_update) </li>
 * <li>_customer_id: MANYTOONE (alias of column _customer_id) (CustomerRepoModel)</li>
 * <li>_inventory_id: MANYTOONE (alias of column _inventory_id) (InventoryRepoModel)</li>
 * <li>_staff_id: MANYTOONE (alias of column _staff_id) (StaffRepoModel)</li>
