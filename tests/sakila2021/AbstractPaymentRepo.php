...
abstract class AbstractPaymentRepo extends Sakila_lite
{
    ...
    public const DEFFKSQL=[
			    ...
			    'rental_id' => 'FOREIGN KEY REFERENCES`rental`(`rental_id`)',
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		!isset($row['payment_id']) and $row['payment_id']=null; // int
		...
		// $row['_rental_id']['_rental_id']=&$row['rental_id']; // linked field MANYTOONE
    ...
    *
    * @param string|array $recursive=['/_customer_id','/_rental_id','/_staff_id'];
    *
    * @return PdoOneQuery
    */
    ...
    */
    ...
    public static function factoryUtil():array {
        return [
		    ...
		    '_rental_id' => RentalRepo::factoryUtil(),
