...
abstract class AbstractInventoryRepo extends Sakila_lite
{
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		// $row['_film_id']['_film_id']=&$row['film_id']; // linked field MANYTOONE
    ...
    *
    * @param string|array $recursive=['/_film_id','/_store_id','/_rental'];
    *
    * @return PdoOneQuery
    */
