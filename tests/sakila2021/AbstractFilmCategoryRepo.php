...
abstract class AbstractFilmCategoryRepo extends Sakila_lite
{
    ...
    public const DEFFK=[
		    'category_id' => [
		        ...
		        'reftable' => 'category',
		        'extra' => '',
		        'name' => 'film_category_fk1',
		        'alias' => 'category_id',
		        'refcolalias' => 'category_id',
		        'refcol2alias' => null
		    ],
		    '_category_id' => [
		        'key' => 'MANYTOONE',
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		// $row['_category_id']['_category_id']=&$row['category_id']; // linked field MANYTOONE
    ...
    *
    * @param string|array $recursive=['/_category_id'];
    *
    * @return PdoOneQuery
    */
    ...
    */
    ...
    public static function factoryUtil():array {
        return [
		    ...
		    'category_id' => null,
		    'last_update' => null,
		    '_category_id' => CategoryRepo::factoryUtil()
		];
    }
