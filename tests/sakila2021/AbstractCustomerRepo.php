...
abstract class AbstractCustomerRepo extends Sakila_lite
{
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		!isset($row['active']) and $row['active']=null; // char
    ...
    *
    * @param string|array $recursive=['/_address_id','/_store_id','/_payment','/_rental'];
    *
    * @return PdoOneQuery
    */
