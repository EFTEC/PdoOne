...
abstract class AbstractCityRepo extends Sakila_lite
{
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		// $row['_country_id']['_country_id']=&$row['country_id']; // linked field MANYTOONE
    ...
    *
    * @param string|array $recursive=['/_country_id','/_address'];
    *
    * @return PdoOneQuery
    */
    ...
    */
    ...
    public static function factoryUtil():array {
        return [
		    ...
		    'country_id' => null,
		    'last_update' => null,
		    '_country_id' => CountryRepo::factoryUtil(),
		    '_address' => [AddresRepo::factoryUtil()]
		];
    }
