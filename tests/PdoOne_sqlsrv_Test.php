...
class PdoOne_sqlsrv_Test extends TestCase
{
    ...
    public function test_quota()
    {
        ...
        $this->assertEquals('[hello] =value',$this->pdoOne->addDelimiter('hello =value'));
        $this->assertEquals('20190101',$this->pdoOne->dateConvert('01/01/2019','human','sql'));
	...
	{
        $this->assertEquals('20190206 05:06:07',PdoOne::dateText2Sql('2019-02-06T05:06:07Z',true));
		$this->assertEquals('20190206 00:00:00',PdoOne::dateText2Sql('2019-02-06',false));
		
		$this->assertEquals('20180206 05:06:07.123000',PdoOne::dateText2Sql('2018-02-06T05:06:07.123Z',true));

		// sql format -> human format dd/mm/yyyy
        $this->assertEquals('06/02/2019',PdoOne::dateSql2Text('20190206'));
		...
		$this->assertEquals('06/02/2019 05:06:07',PdoOne::dateSql2Text('20190206 05:06:07'));
		$this->assertEquals('06/02/2018 05:06:07.123000',PdoOne::dateSql2Text('20180206 05:06:07.123'));
	}
