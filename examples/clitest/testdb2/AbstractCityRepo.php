...
abstract class AbstractCityRepo extends Testdb2
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['NumCity']) and $row['NumCity']=null; // int
		!isset($row['NameCity']) and $row['NameCity']=null; // varchar
