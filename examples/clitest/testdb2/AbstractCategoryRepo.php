...
abstract class AbstractCategoryRepo extends Testdb2
{
    ...
    public const DEFFK=[
		    '_customerxcategories' => [
		        ...
		        'colalias' => 'NumCategory',
		        'refcolalias' => 'Category',
		        'refcol2alias' => null
		    ]
		];
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['NumCategory']) and $row['NumCategory']=null; // int
    ...
    */
    ...
    public static function factoryUtil() {
        return [
		    'NumCategory' => null,
		    'Name' => null,
		    '_customerxcategories' => [CustomerXCategoryRepo::factoryUtil()]
		];
    }
