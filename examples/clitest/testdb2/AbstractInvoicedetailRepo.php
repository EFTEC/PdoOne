...
/**
* Class AbstractInvoicedetailRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractInvoicedetailRepo extends Testdb2
{
    ...
    public const DEFFK=[
		    'Invoice' => [
		        ...
		        'reftable' => 'invoices',
		        'extra' => '',
		        'name' => 'invoicedetails_fk2',
		        'alias' => '_Invoice',
		        'refcolalias' => 'NumInvoice',
		        'refcol2alias' => null
		    ],
		    '_Invoice' => [
		        'key' => 'PARENT',
		    ...
		    'Product' => [
		        ...
		        'reftable' => 'products',
		        'extra' => '',
		        'name' => 'invoicedetails_fk1',
		        'alias' => '_Product',
		        'refcolalias' => 'Numproduct',
		        'refcol2alias' => null
		    ],
		    '_Product' => [
		        'key' => 'MANYTOONE',
    ...
    public const DEFFKSQL=[
			    'Invoice' => 'FOREIGN KEY REFERENCES`invoices`(`IdInvoice`)',
			    'Product' => 'FOREIGN KEY REFERENCES`products`(`IdProducts`)'
			];
    ...
    public const ALIAS2COL=[
		    'NumInvoiceDetail' => 'IdInvoiceDetail',
		    'Invoice' => 'Invoice',
		    'Product' => 'Product',
		    'Quantity' => 'Quantity'
		];
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['NumInvoiceDetail']) and $row['NumInvoiceDetail']=null; // int
		!isset($row['Invoice']) and $row['Invoice']=null; // int
		!isset($row['Product']) and $row['Product']=null; // int
		!isset($row['Quantity']) and $row['Quantity']=null; // int
		// $row['_Product']['_Numproduct']=&$row['Product']; // linked field MANYTOONE
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,InvoicedetailRepo::TABLE);
    }
    ...
    */
    ...
    public static function factoryUtil() {
        return [
		    ...
		    'Quantity' => null,
		    '_Invoice' => null,
		    '_Product' => ProductRepo::factoryUtil()
		];
    }
