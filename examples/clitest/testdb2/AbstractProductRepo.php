...
abstract class AbstractProductRepo extends Testdb2
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['Numproduct']) and $row['Numproduct']=null; // int
