...
/**
* Class AbstractCustomerXCategoryRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractCustomerXCategoryRepo extends Testdb2
{
    ...
    public const DEFFK=[
		    'Category' => [
		        ...
		        'reftable' => 'categories',
		        'extra' => '',
		        'name' => 'customerxcategories_fk2',
		        'alias' => '_Category',
		        'refcolalias' => 'NumCategory',
		        'refcol2alias' => null
		    ],
		    '_Category' => [
		        'key' => 'MANYTOONE',
    ...
    public const DEFFKSQL=[
			    'Category' => 'FOREIGN KEY REFERENCES`categories`(`IdCategory`)',
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['Category']) and $row['Category']=null; // int
		// $row['_Category']['_NumCategory']=&$row['Category']; // linked field MANYTOONE
		isset($row['_Customer']) and $row['_Customer']['_NumCustomer']=&$row['Customer']; // linked field ONETOONE
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,CustomerXCategoryRepo::TABLE);
    }
    ...
    */
    public static function setRecursive($recursive=[])
    {
        if(is_string($recursive)) {
            $recursive=CustomerXCategoryRepo::getRelations($recursive);
        }
    ...
    */
    ...
    public static function factoryUtil() {
        return [
		    'Customer' => null,
		    'Category' => null,
		    '_Category' => CategoryRepo::factoryUtil(),
