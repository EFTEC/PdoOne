...
/**
* Class AbstractTablegrandchildRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractTablegrandchildRepo extends Testdb
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['idgrandchildPK']) and $row['idgrandchildPK']=null; // int
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,TablegrandchildRepo::TABLE);
    }
