...
* Class AbstractActorRepo
* <pre>
 * $code=$pdoOne->generateCodeClass('actor','eftec\examples\clitest\repo2',array('actor_id'=>NULL,'first_name'=>NULL,'last_name'=>'nothing','last_update'=>NULL,'_film_actor'=>'ONETOMANY',),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','Sakila','',array('colnew'=>'now()',),array());
 * </pre>
*/
abstract class AbstractActorRepo extends Sakila
{
    const TABLE = 'actor';
    const IDENTITY = 'actor_id';
    const PK = [
	    'actor_id'
	];
    const ME=__CLASS__;
    const EXTRACOLS='now() as `colnew`';
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['last_name']) and $row['last_name']=null; // no conversion
		!isset($row['last_update']) and $row['last_update']=null; // timestamp
		!isset($row['colnew']) and $row['colnew']=null; // 
