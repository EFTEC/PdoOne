...
/**
* Class AbstractTablecategoryRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractTablecategoryRepo extends Testdb
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['IdTableCategoryPK']) and $row['IdTableCategoryPK']=null; // int
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,TablecategoryRepo::TABLE);
    }
