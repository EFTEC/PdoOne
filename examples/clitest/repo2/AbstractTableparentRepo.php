...
/**
* Class AbstractTableParentRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractTableParentRepo extends Testdb
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['idtablaparentPK']) and $row['idtablaparentPK']=null; // int
		!isset($row['FieldText']) and $row['FieldText']=null; // varchar
		!isset($row['idchildFK']) and $row['idchildFK']=null; // int
		!isset($row['IdChild2Foreign']) and $row['IdChild2Foreign']=null; // int
		!isset($row['fieldInt']) and $row['fieldInt']=null; // int
		!isset($row['fielDecimal']) and $row['fielDecimal']=null; // double
		!isset($row['fieldDateTime']) and $row['fieldDateTime']=null; // datetime
		!isset($row['fieldUnique']) and $row['fieldUnique']=null; // varchar
		!isset($row['FieldKey']) and $row['FieldKey']=null; // varchar
		isset($row['_IdChild2Foreign']) and $row['_IdChild2Foreign']['_idtablachildPK']=&$row['IdChild2Foreign']; // linked field MANYTOONE
		isset($row['_idchildFK']) and $row['_idchildFK']['_idtablachildPK']=&$row['idchildFK']; // linked field MANYTOONE
		isset($row['_TableParentExt']) and $row['_TableParentExt']['_idtablaparentExtPK']=&$row['TableParentExt']; // linked field ONETOONE
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
		...
		'_idchildFK'=>(in_array($recursivePrefix.'_idchildFK',$recursive,true))
		                            ...
		                            : null, /* MANYTOONE!! */
		'IdChild2Foreign'=>0,
		'_IdChild2Foreign'=>(in_array($recursivePrefix.'_IdChild2Foreign',$recursive,true))
		                            ? TablechildRepo::factory(null,$recursivePrefix.'_IdChild2Foreign')
		                            : null, /* manytoone */
		'fieldInt'=>0,
		'fielDecimal'=>0.0,
		'fieldDateTime'=>'',
    ...
    */
    public static function factoryNull($values=null) {
		...
		'IdChild2Foreign'=>null,
		'_IdChild2Foreign'=>null, /* manytoone */
		'fieldInt'=>null,
		'fielDecimal'=>null,
		'fieldDateTime'=>null,
		'fieldUnique'=>null,
