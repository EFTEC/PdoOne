...
* Class AbstractPaymentRepo
* <pre>
 * $code=$pdoOne->generateCodeClass('payment','eftec\examples\clitest\repo2',array('amount'=>NULL,'customer_id'=>NULL,'last_update'=>NULL,'payment_date'=>NULL,'payment_id'=>NULL,'rental_id'=>NULL,'staff_id'=>NULL,'_customer_id'=>'MANYTOONE','_rental_id'=>'MANYTOONE','_staff_id'=>'MANYTOONE',),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','Sakila','',array(),array());
 * </pre>
*/
abstract class AbstractPaymentRepo extends Sakila
{
    const TABLE = 'payment';
    const IDENTITY = 'payment_id';
    const PK = [
	    'payment_id'
	];
    const ME=__CLASS__;
