...
* Class AbstractFilm2Repo
* <pre>
 * $code=$pdoOne->generateCodeClass('film2','eftec\examples\clitest\repo2',array('description'=>NULL,'film_id'=>NULL,'language_id'=>NULL,'last_update'=>NULL,'length'=>NULL,'original_language_id'=>NULL,'rating'=>NULL,'release_year'=>NULL,'rental_duration'=>NULL,'rental_rate'=>NULL,'replacement_cost'=>NULL,'special_features'=>NULL,'title'=>NULL,'_language_id'=>'MANYTOONE','_original_language_id'=>'MANYTOONE',),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','Sakila','',array(),array());
 * </pre>
*/
abstract class AbstractFilm2Repo extends Sakila
{
    const TABLE = 'film2';
