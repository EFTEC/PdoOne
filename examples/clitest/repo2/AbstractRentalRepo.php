...
* Class AbstractRentalRepo
* <pre>
 * $code=$pdoOne->generateCodeClass('rental','eftec\examples\clitest\repo2',array('customer_id'=>NULL,'inventory_id'=>NULL,'last_update'=>NULL,'rental_date'=>NULL,'rental_id'=>NULL,'return_date'=>NULL,'staff_id'=>NULL,'_customer_id'=>'MANYTOONE','_inventory_id'=>'MANYTOONE','_staff_id'=>'MANYTOONE','_payment'=>'ONETOMANY',),array('actor'=>'ActorRepo','actor2'=>'Actor2Repo','address'=>'AddresRepo','category'=>'CategoryRepo','city'=>'CityRepo','country'=>'CountryRepo','customer'=>'CustomerRepo','dummyt'=>'DummytRepo','dummytable'=>'DummytableRepo','film'=>'FilmRepo','film2'=>'Film2Repo','film_actor'=>'FilmActorRepo','film_category'=>'FilmCategoryRepo','film_text'=>'FilmTextRepo','fum_jobs'=>'FumJobRepo','fum_logs'=>'FumLogRepo','inventory'=>'InventoryRepo','language'=>'LanguageRepo','mysec_table'=>'MysecTableRepo','payment'=>'PaymentRepo','product'=>'ProductRepo','producttype'=>'ProducttypeRepo','producttype_auto'=>'ProducttypeAutoRepo','rental'=>'RentalRepo','staff'=>'StaffRepo','store'=>'StoreRepo','tablachild'=>'TablachildRepo','tablagrandchild'=>'TablagrandchildRepo','tablaparent'=>'TablaparentRepo','tabletest'=>'TabletestRepo','test_products'=>'TestProductRepo','typetable'=>'TypetableRepo',),array(),'','','Sakila','',array(),array());
 * </pre>
*/
abstract class AbstractRentalRepo extends Sakila
{
    const TABLE = 'rental';
    const IDENTITY = 'rental_id';
    const PK = [
	    'rental_id'
	];
    const ME=__CLASS__;
