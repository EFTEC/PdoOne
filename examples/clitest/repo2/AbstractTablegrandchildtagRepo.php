...
abstract class AbstractTablegrandchildtagRepo extends Testdb
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['IdTablaGrandChildTagPK']) and $row['IdTablaGrandChildTagPK']=null; // int
