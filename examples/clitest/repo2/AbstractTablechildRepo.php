...
/**
* Class AbstractTablechildRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractTablechildRepo extends Testdb
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['idtablachildPK']) and $row['idtablachildPK']=null; // int
		!isset($row['NameChild']) and $row['NameChild']=null; // varchar
		!isset($row['idgrandchildFK']) and $row['idgrandchildFK']=null; // int
		isset($row['_idgrandchildFK']) and $row['_idgrandchildFK']['_idgrandchildPK']=&$row['idgrandchildFK']; // linked field MANYTOONE
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,TablechildRepo::TABLE);
    }
    ...
    public static function getDefFK($structure=false) {
        ...
        return [
		    'idgrandchildFK' => [
		        ...
		        'extra' => '',
		        'name' => 'fk_TableChild_idgrandchildFK',
		        'alias' => '_idgrandchildFK'
		    ],
		    '_idgrandchildFK' => [
		        'key' => 'MANYTOONE',
		        'refcol' => 'idgrandchildPK',
