...
/**
* Class AbstractTableparentextRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractTableparentextRepo extends Testdb
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['idtablaparentExtPK']) and $row['idtablaparentExtPK']=null; // int
		!isset($row['fieldExt']) and $row['fieldExt']=null; // varchar
		isset($row['_idtablaparentExtPK']) and $row['_idtablaparentExtPK']['_idtablaparentPK']=&$row['idtablaparentExtPK']; // linked field ONETOONE
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,TableparentextRepo::TABLE);
    }
    ...
    public static function getDefFK($structure=false) {
        ...
        return [
		    'idtablaparentExtPK' => [
		        ...
		        'extra' => '',
		        'name' => 'fk_TableParentExt_idtablaparentExtPK',
		        'alias' => '_idtablaparentExtPK'
		    ],
		    '_idtablaparentExtPK' => [
		        'key' => 'ONETOONE',
		        'refcol' => 'idtablaparentPK',
    ...
    */
    public static function factory($values = null, $recursivePrefix = '') {
		...
		'_idtablaparentExtPK'=>(in_array($recursivePrefix.'_idtablaparentExtPK',$recursive,true)) 
		                            ? TableParentRepo::factory(null,$recursivePrefix.'_idtablaparentExtPK') 
		                            : null, /* ONETOONE!! */
		'fieldExt'=>''
		];
        		isset($row['_idtablaparentExtPK']) and $row['_idtablaparentExtPK']['_idtablaparentPK']=&$row['idtablaparentExtPK']; // linked field ONETOONE
