...
/**
* Class AbstractTableparentxcategoryRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
...
abstract class AbstractTableparentxcategoryRepo extends Testdb
{
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['idtablaparentPKFK']) and $row['idtablaparentPKFK']=null; // int
		!isset($row['idcategoryPKFK']) and $row['idcategoryPKFK']=null; // int
		isset($row['_idcategoryPKFK']) and $row['_idcategoryPKFK']['_IdTableCategoryPK']=&$row['idcategoryPKFK']; // linked field MANYTOONE
		isset($row['_idtablaparentPKFK']) and $row['_idtablaparentPKFK']['_idtablaparentPK']=&$row['idtablaparentPKFK']; // linked field ONETOONE
