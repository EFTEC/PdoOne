 ...
 * @throws Exception
 */
function s5f147137353d3__auto($class_name)
{
    ...
    // special cases
    if (isset($GLOBALS['s5f147137353d3__arrautoloadCustom'][$class_name])) {
        s5f147137353d3__loadIfExists($GLOBALS['s5f147137353d3__arrautoloadCustom'][$class_name]
            , $class_name,'s5f147137353d3__arrautoloadCustomCommon');
        return;
    }
    // normal (folder) cases
    if (isset($GLOBALS['s5f147137353d3__arrautoload'][$ns])) {
        s5f147137353d3__loadIfExists($GLOBALS['s5f147137353d3__arrautoload'][$ns] . '/' . $cls . '.php'
            , $ns,'s5f147137353d3__arrautoloadCommon');
        return;
    }
}
 ...
 * @throws Exception
 */
function s5f147137353d3__loadIfExists($filename, $key,$arrayName='')
{
    if (isset($GLOBALS['s5f147137353d3__arrautoloadAbsolute'][$key])) {
        ...
        $fullFile = __DIR__ . '/' . s5f147137353d3__replaceCurlyVariable($filename, $arrayName); // its relative to this path
    }
    /** @noinspection PhpIncludeInspection */
    if ((@include $fullFile) === false) {
        if ($GLOBALS['s5f147137353d3__debug']) {
...
function s5f147137353d3__replaceCurlyVariable($string,$arrayName) {
...
spl_autoload_register(static function ($class_name) {
    s5f147137353d3__auto($class_name);
});
// autorun
