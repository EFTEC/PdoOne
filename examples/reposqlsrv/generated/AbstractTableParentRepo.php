 ...
 * <pre>
 * $code=$pdoOne->generateCodeClass('TableParent','reposqlsrv',array('_idchild2FK'=>'PARENT','_TableParentxCategory'=>'MANYTOMANY',),array('TableParent'=>'TableParentRepo','TableChild'=>'TableChildRepo','TableGrandChild'=>'TableGrandChildRepo','TableGrandChildTag'=>'TableGrandChildTagRepo','TableParentxCategory'=>'TableParentxCategoryRepo','TableCategory'=>'TableCategoryRepo','TableParentExt'=>'TableParentExtRepo',),array(),'','','TestDb','sqlsrv\repomodel\TableParentModel');
 * </pre>
 */
abstract class AbstractTableParentRepo extends TestDb
{
    ...
    public static function factory($recursivePrefix='') {
        ...
        return [
		'idtablaparentPK'=>0,
		'_TableParentxCategory'=>(in_array($recursivePrefix.'_TableParentxCategory',$recursive))
		                            ? [] 
		                            : null, /* MANYTOMANY! */
		'_TableParentExt'=>(in_array($recursivePrefix.'_TableParentExt',$recursive))
		                            ? TableParentExt::factory($recursivePrefix.'_TableParentExt') 
		                            : null, /* ONETOONE! */
		'fieldVarchar'=>'',
		'idchildFK'=>0,
		'_idchildFK'=>(in_array($recursivePrefix.'_idchildFK',$recursive)) 
