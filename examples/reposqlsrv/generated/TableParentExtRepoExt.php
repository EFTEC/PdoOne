...
class TableParentExtRepoExt extends TestDb
{
    ...
    public static function factory($recursivePrefix='') {
		...
		'/idtablaparentExtPK'=>(in_array($recursivePrefix.'/idtablaparentExtPK',$recursive)) 
		                            ? TableParentRepo::factory($recursivePrefix.'/idtablaparentExtPK') 
		                            : null, /* ONETOONE!! */
		'fieldExt'=>''
		];
    }
    ...
    public static function factoryNull() {
		...
		'/idtablaparentExtPK'=>null, /* ONETOONE!! */
		'fieldExt'=>null
		];
    }
