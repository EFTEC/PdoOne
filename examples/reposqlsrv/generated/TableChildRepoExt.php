...
class TableChildRepoExt extends TestDb
{
    ...
    public static function factory($recursivePrefix='') {
        ...
        return [
		'idtablachildPK'=>0,
		'/TableParent'=>(in_array($recursivePrefix.'/TableParent',$recursive))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'NameChild'=>'',
		'idgrandchildFK'=>0,
		'/idgrandchildFK'=>(in_array($recursivePrefix.'/idgrandchildFK',$recursive)) 
		                            ? TableGrandChildRepo::factory($recursivePrefix.'/idgrandchildFK') 
		                            : null, /* MANYTOONE!! */
		];
    }
