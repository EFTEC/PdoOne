 ...
 * </pre>
 */
class TableParentxCategoryRepoExt extends TestDb
{
    ...
    public static function factory($recursivePrefix='') {
        ...
        return [
		'idtablaparentPKFK'=>0,
		'/idtablaparentPKFK'=>(in_array($recursivePrefix.'/idtablaparentPKFK',$recursive)) 
		                            ? TableParentRepo::factory($recursivePrefix.'/idtablaparentPKFK') 
		                            : null, /* ONETOONE!! */
		'idcategoryPKFK'=>0,
		'/idcategoryPKFK'=>(in_array($recursivePrefix.'/idcategoryPKFK',$recursive)) 
		                            ? TableCategoryRepo::factory($recursivePrefix.'/idcategoryPKFK') 
		                            : null, /* MANYTOONE!! */
		];
    }
    ...
    public static function factoryNull() {
		...
		'/idtablaparentPKFK'=>null, /* ONETOONE!! */
		'idcategoryPKFK'=>null,
