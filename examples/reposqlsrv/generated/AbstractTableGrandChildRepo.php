 ...
 * <pre>
 * $code=$pdoOne->generateCodeClass('TableGrandChild','reposqlsrv',array(),array('TableParent'=>'TableParentRepo','TableChild'=>'TableChildRepo','TableGrandChild'=>'TableGrandChildRepo','TableGrandChildTag'=>'TableGrandChildTagRepo','TableParentxCategory'=>'TableParentxCategoryRepo','TableCategory'=>'TableCategoryRepo','TableParentExt'=>'TableParentExtRepo',),array(),'','','TestDb','sqlsrv\repomodel\TableGrandChildModel');
 * </pre>
 */
abstract class AbstractTableGrandChildRepo extends TestDb
{
    ...
    public static function factory($recursivePrefix='') {
        ...
        return [
		'idgrandchildPK'=>0,
		'_TableGrandChildTag'=>(in_array($recursivePrefix.'_TableGrandChildTag',$recursive))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'_TableChild'=>(in_array($recursivePrefix.'_TableChild',$recursive))
		                            ? [] 
		                            : null, /* ONETOMANY! */
		'NameGrandChild'=>''
		];
