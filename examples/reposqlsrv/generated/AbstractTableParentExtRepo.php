 ...
 * <pre>
 * $code=$pdoOne->generateCodeClass('TableParentExt','reposqlsrv',array(),array('TableParent'=>'TableParentRepo','TableChild'=>'TableChildRepo','TableGrandChild'=>'TableGrandChildRepo','TableGrandChildTag'=>'TableGrandChildTagRepo','TableParentxCategory'=>'TableParentxCategoryRepo','TableCategory'=>'TableCategoryRepo','TableParentExt'=>'TableParentExtRepo',),array(),'','','TestDb','sqlsrv\repomodel\TableParentExtModel');
 * </pre>
 */
abstract class AbstractTableParentExtRepo extends TestDb
{
    ...
    public static function factory($recursivePrefix='') {
		...
		'_idtablaparentExtPK'=>(in_array($recursivePrefix.'_idtablaparentExtPK',$recursive)) 
