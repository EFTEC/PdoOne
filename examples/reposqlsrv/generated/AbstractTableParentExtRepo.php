...
* <pre>
* $code=$pdoOne->generateCodeClass('TableParentExt','reposqlsrv',array(),array('TableParent'=>'TableParentRepo','TableChild'=>'TableChildRepo','TableGrandChild'=>'TableGrandChildRepo','TableGrandChildTag'=>'TableGrandChildTagRepo','TableParentxCategory'=>'TableParentxCategoryRepo','TableCategory'=>'TableCategoryRepo','TableParentExt'=>'TableParentExtRepo',),array(),'','','TestDb','sqlsrv\repomodel\TableParentExtModel',array(),array());
* </pre>
*/
    ...
    */
    public static function convertOutputVal(&$row)
    {
		...
		!isset($row['fieldExt']) and $row['fieldExt']=null; // varchar
        		isset($row['_idtablaparentExtPK'])
            and $row['_idtablaparentExtPK']['idtablaparentPK']=&$row['idtablaparentExtPK']; // linked ONETOONE
