...
/**
 * Generated by PdoOne Version 1.45 Date generated Thu, 11 Jun 2020 16:40:40 -0400. 
 * DO NOT EDIT THIS CODE. Use instead the Repo Class.
 * @copyright (c) Jorge Castro C. MIT License  https://github.com/EFTEC/PdoOne
 * Class BlogDao
 * <pre>
 * $code=$pdoOne->generateCodeClass('Blog','repo',array('/idchild2FK'=>'PARENT','/tablaparentxcategory'=>'MANYTOMANY',),'Dao');
 * </pre>
 */
class BlogDao extends _BasePdoOneRepo
{
    const TABLE = 'Blog';
    const PK = [
	    'IdBlog'
    ...
    public static function getDefFK($structure=false) {
        if ($structure) {
            return [
			    'IdBlogCategory' => 'FOREIGN KEY REFERENCES`blogcategory`(`IdBlogCategory`)'
			];
        }
        ...
        return [
		    'IdBlogCategory' => [
		        'key' => 'FOREIGN KEY',
		        'refcol' => 'IdBlogCategory',
		        'reftable' => 'blogcategory',
		        'extra' => '',
		        'name' => 'blog_fk1'
		    ],
		    '/IdBlogCategory' => [
