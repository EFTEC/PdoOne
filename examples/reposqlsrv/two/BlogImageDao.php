 ...
 * Class BlogImageDao
 * <pre>
 * $code=$pdoOne->generateCodeClass('BlogImage','repo',array('/idchild2FK'=>'PARENT','/tablaparentxcategory'=>'MANYTOMANY',),'Dao');
 * </pre>
 */
class BlogImageDao extends _BasePdoOneRepo
{
    ...
    public static function getDefFK($structure=false) {
        if ($structure) {
            return [
			    'IdBlog' => 'FOREIGN KEY REFERENCES`blog`(`IdBlog`)'
			];
        }
